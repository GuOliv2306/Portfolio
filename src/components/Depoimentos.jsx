...
import { Reveal, SectionNumber, SectionEyebrow } from './primitives.jsx';
  ...
  return (
    <section id="depoimentos" data-screen-label="05 Depoimentos" style={{
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="dep-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          {ITEMS.map((it) => (
            <Reveal key={it.num} delay={120 + Number(it.num) * 100}>
              <figure style={{
                position: 'relative',
                minHeight: 260,
